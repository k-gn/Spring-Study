...
import com.fc.jpa.bookmanager.repository.dto.BookNameAndCategory;
...
//    List<Object[]> findBookNameAndCategoryObj();
    ...
    @Query(value = "select new com.fc.jpa.bookmanager.repository.dto.BookNameAndCategory(b.name, b.category) from Book b")
